...
namespace PetGrooming.Controllers
{
    public class PetController : Controller
    {
        ...
        public ActionResult Update(int id, string PetName, string PetColor, double PetWeight, string PetNotes, int SpeciesID)
        {
            ...
            SqlParameter[] parameter = new SqlParameter[6];//5 infor to pass through

            parameter[0] = new SqlParameter("@PetName",PetName);
            parameter[1] = new SqlParameter("@PetWeight", PetWeight);
            parameter[2] = new SqlParameter("@PetColor", PetColor);
            parameter[3] = new SqlParameter("@PetNotes", PetNotes);
            parameter[4] = new SqlParameter("@SpeciesID", SpeciesID);
            parameter[5] = new SqlParameter("@id", id); 
